...
public class BackgroundController : MonoBehaviour 
{
    ...
    void Update () 
    {
        ...
        {
            Vector2 offset = new Vector2(Subject.transform.position.x / Backgrounds[i].transform.localScale.x, Subject.transform.position.z / Backgrounds[i].transform.localScale.y);
